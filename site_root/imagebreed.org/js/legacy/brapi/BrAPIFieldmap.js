(function (global, factory) {
	...
	*/
	...
	(function (factory, window) {
	    ...
	    // ðminiclass CancelableEvent (Event objects)
	    // ðmethod cancel()
	    // Cancel any subsequent action.

	    // ðminiclass VertexEvent (Event objects)
	    // ðproperty vertex: VertexMarker
	    // The vertex that fires the event.

	    // ðminiclass ShapeEvent (Event objects)
	    // ðproperty shape: Array
	    // The shape (LatLngs array) subject of the action.

	    // ðminiclass CancelableVertexEvent (Event objects)
	    // ðinherits VertexEvent
	    // ðinherits CancelableEvent

	    // ðminiclass CancelableShapeEvent (Event objects)
	    // ðinherits ShapeEvent
	    // ðinherits CancelableEvent

	    // ðminiclass LayerEvent (Event objects)
	    // ðproperty layer: object
	    // The Layer (Marker, Polylineâ¦) subject of the action.

	    // ðnamespace Editable; ðclass Editable; ðaka L.Editable
	    ...
	    L$$1.Editable = L$$1.Evented.extend({
	        ...
	        options: {
	            ...
	            // ðoption zIndex: int = 1000
	            // The default zIndex of the editing tools.
	            zIndex: 1000,

	            // ðoption polygonClass: class = L.Polygon
	            // Class to be used when creating a new Polygon.
	            polygonClass: L$$1.Polygon,

	            // ðoption polylineClass: class = L.Polyline
	            // Class to be used when creating a new Polyline.
	            polylineClass: L$$1.Polyline,

	            // ðoption markerClass: class = L.Marker
	            // Class to be used when creating a new Marker.
	            markerClass: L$$1.Marker,

	            // ðoption rectangleClass: class = L.Rectangle
	            // Class to be used when creating a new Rectangle.
	            rectangleClass: L$$1.Rectangle,

	            // ðoption circleClass: class = L.Circle
	            // Class to be used when creating a new Circle.
	            circleClass: L$$1.Circle,

	            // ðoption drawingCSSClass: string = 'leaflet-editable-drawing'
	            // CSS class to be added to the map container while drawing.
	            drawingCSSClass: 'leaflet-editable-drawing',

	            // ðoption drawingCursor: const = 'crosshair'
	            // Cursor mode set to the map while drawing.
	            drawingCursor: 'crosshair',

	            // ðoption editLayer: Layer = new L.LayerGroup()
	            // Layer used to store edit tools (vertex, line guideâ¦).
	            editLayer: undefined,

	            // ðoption featuresLayer: Layer = new L.LayerGroup()
	            // Default layer used to store drawn features (Marker, Polylineâ¦).
	            featuresLayer: undefined,

	            // ðoption polylineEditorClass: class = PolylineEditor
	            // Class to be used as Polyline editor.
	            polylineEditorClass: undefined,

	            // ðoption polygonEditorClass: class = PolygonEditor
	            // Class to be used as Polygon editor.
	            polygonEditorClass: undefined,

	            // ðoption markerEditorClass: class = MarkerEditor
	            // Class to be used as Marker editor.
	            markerEditorClass: undefined,

	            // ðoption rectangleEditorClass: class = RectangleEditor
	            // Class to be used as Rectangle editor.
	            rectangleEditorClass: undefined,

	            // ðoption circleEditorClass: class = CircleEditor
	            // Class to be used as Circle editor.
	            circleEditorClass: undefined,

	            // ðoption lineGuideOptions: hash = {}
	            // Options to be passed to the line guides.
	            lineGuideOptions: {},

	            // ðoption skipMiddleMarkers: boolean = false
	        ...
	        // ðsection Public methods
	        // You will generally access them by the `map.editTools`
	        // instance:
	        //
	        // `map.editTools.startPolyline();`

	        // ðmethod drawing(): boolean
	        // Return true if any drawing action is ongoing.
	        drawing: function () {
	            return this._drawingEditor && this._drawingEditor.drawing();
	        },

	        // ðmethod stopDrawing()
	        // When you need to stop any ongoing drawing, without needing to know which editor is active.
	        stopDrawing: function () {
	            this.unregisterForDrawing();
	        },

	        // ðmethod commitDrawing()
	        ...
	        // ðmethod startPolyline(latlng: L.LatLng, options: hash): L.Polyline
	        ...
	        // ðmethod startPolygon(latlng: L.LatLng, options: hash): L.Polygon
	        ...
	        // ðmethod startMarker(latlng: L.LatLng, options: hash): L.Marker
	        ...
	        // ðmethod startRectangle(latlng: L.LatLng, options: hash): L.Rectangle
	        ...
	        // ðmethod startCircle(latlng: L.LatLng, options: hash): L.Circle
	        ...
	        createLayer: function (klass, latlngs, options) {
	            ...
	            // ðnamespace Editable
	            // ðevent editable:created: LayerEvent
	    ...
	    // });
	    // ```
	    // ðsection Editable Map Options
	    L$$1.Map.mergeOptions({

	        // ðnamespace Map
	        // ðsection Map Options
	        // ðoption editToolsClass: class = L.Editable
	        // Class to be used as vertex, for path editing.
	        editToolsClass: L$$1.Editable,

	        // ðoption editable: boolean = false
	        // Whether to create a L.Editable instance at map init.
	        editable: false,

	        // ðoption editOptions: hash = {}
	    ...
	    // ðnamespace Editable; ðclass VertexMarker; Handler for dragging path vertices.
	    L$$1.Editable.VertexMarker = L$$1.Marker.extend({
	        ...
	        // ðmethod getIndex(): int
	        // Get the index of the current vertex among others of the same LatLngs group.
	        getIndex: function () {
	            return this.latlngs.indexOf(this.latlng);
	        },

	        // ðmethod getLastIndex(): int
	        // Get last vertex index of the LatLngs group of the current vertex.
	        getLastIndex: function () {
	            return this.latlngs.length - 1;
	        },

	        // ðmethod getPrevious(): VertexMarker
	    ...
	    L$$1.Editable.mergeOptions({
	        ...
	        // ðnamespace Editable
	        // ðoption vertexMarkerClass: class = VertexMarker
	        // Class to be used as vertex, for path editing.
	    ...
	    L$$1.Editable.mergeOptions({
	        ...
	        // ðnamespace Editable
	        // ðoption middleMarkerClass: class = VertexMarker
	        // Class to be used as middle vertex, pulled by the user to create a new point in the middle of a path.
	        middleMarkerClass: L$$1.Editable.MiddleMarker

	    });

	    // ðnamespace Editable; ðclass BaseEditor; ðaka L.Editable.BaseEditor
	    ...
	    L$$1.Editable.BaseEditor = L$$1.Handler.extend({
	        ...
	        onDisable: function () {
	            // ðnamespace Editable
	            // ðevent editable:disable: Event
	        ...
	        onEditing: function () {
	            // ðnamespace Editable
	            // ðevent editable:editing: Event
	        ...
	        onStartDrawing: function () {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:start: Event
	        ...
	        onEndDrawing: function () {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:end: Event
	        ...
	        onCancelDrawing: function () {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:cancel: Event
	        ...
	        onCommitDrawing: function (e) {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:commit: Event
	        ...
	        onDrawingMouseDown: function (e) {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:mousedown: Event
	        ...
	        onDrawingMouseUp: function (e) {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:mouseup: Event
	        ...
	        onDrawingClick: function (e) {
	            ...
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:click: CancelableEvent
	        ...
	        onMove: function (e) {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:move: Event
	        ...
	        onDragStart: function (e) {
	            this.onEditing();
	            // ðnamespace Editable
	            // ðevent editable:dragstart: Event
	        ...
	        onDragEnd: function (e) {
	            // ðnamespace Editable
	            // ðevent editable:dragend: Event
	    ...
	    // ðnamespace Editable; ðclass MarkerEditor; ðaka L.Editable.MarkerEditor
	    // ðinherits BaseEditor
	    // Editor for Marker.
	    L$$1.Editable.MarkerEditor = L$$1.Editable.BaseEditor.extend({
	        ...
	        processDrawingClick: function (e) {
	            // ðnamespace Editable
	            // ðsection Drawing events
	            // ðevent editable:drawing:clicked: Event
	    ...
	    // ðnamespace Editable; ðclass PathEditor; ðaka L.Editable.PathEditor
	    // ðinherits BaseEditor
	    ...
	    L$$1.Editable.PathEditor = L$$1.Editable.BaseEditor.extend({
	        ...
	        onNewVertex: function (vertex) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:new: VertexEvent
	        ...
	        onVertexMarkerClick: function (e) {
	            ...
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:click: CancelableVertexEvent
	            ...
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:clicked: VertexEvent
	        ...
	        onVertexRawMarkerClick: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:rawclick: CancelableVertexEvent
	        ...
	        onVertexDeleted: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:deleted: VertexEvent
	        ...
	        onVertexMarkerCtrlClick: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:ctrlclick: VertexEvent
	        ...
	        onVertexMarkerShiftClick: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:shiftclick: VertexEvent
	        ...
	        onVertexMarkerMetaKeyClick: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:metakeyclick: VertexEvent
	        ...
	        onVertexMarkerAltClick: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:altclick: VertexEvent
	        ...
	        onVertexMarkerContextMenu: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:contextmenu: VertexEvent
	        ...
	        onVertexMarkerMouseDown: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:mousedown: VertexEvent
	        ...
	        onVertexMarkerMouseOver: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:mouseover: VertexEvent
	        ...
	        onVertexMarkerMouseOut: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:mouseout: VertexEvent
	        ...
	        onMiddleMarkerMouseDown: function (e) {
	            // ðnamespace Editable
	            // ðsection MiddleMarker events
	            // ðevent editable:middlemarker:mousedown: VertexEvent
	        ...
	        onVertexMarkerDrag: function (e) {
	            ...
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:drag: VertexEvent
	        ...
	        onVertexMarkerDragStart: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:dragstart: VertexEvent
	        ...
	        onVertexMarkerDragEnd: function (e) {
	            // ðnamespace Editable
	            // ðsection Vertex events
	            // ðevent editable:vertex:dragend: VertexEvent
	        ...
	        // ðnamespace PathEditor
	        // ðmethod newShape(latlng?: L.LatLng)
	        ...
	        newShape: function (latlng) {
	            ...
	            // ðnamespace Editable
	            // ðsection Shape events
	            // ðevent editable:shape:new: ShapeEvent
	        ...
	        deleteShape: function (shape, latlngs) {
	            ...
	            // ðnamespace Editable
	            // ðsection Shape events
	            // ðevent editable:shape:delete: CancelableShapeEvent
	            ...
	            // ðnamespace Editable
	            // ðsection Shape events
	            // ðevent editable:shape:deleted: ShapeEvent
	        ...
	        // ðnamespace PathEditor
	        // ðmethod deleteShapeAt(latlng: L.LatLng): Array
	        ...
	        // ðmethod appendShape(shape: Array)
	        // Append a new shape to the Polygon or Polyline.
	        appendShape: function (shape) {
	            this.insertShape(shape);
	        },

	        // ðmethod prependShape(shape: Array)
	        // Prepend a new shape to the Polygon or Polyline.
	        prependShape: function (shape) {
	            this.insertShape(shape, 0);
	        },

	        // ðmethod insertShape(shape: Array, index: int)
	    ...
	    // ðnamespace Editable; ðclass PolylineEditor; ðaka L.Editable.PolylineEditor
	    // ðinherits PathEditor
	    L$$1.Editable.PolylineEditor = L$$1.Editable.PathEditor.extend({
	        ...
	        // ðmethod continueBackward(latlngs?: Array)
	        ...
	        // ðmethod continueForward(latlngs?: Array)
	        ...
	        // ðmethod splitShape(latlngs?: Array, index: int)
	    ...
	    // ðnamespace Editable; ðclass PolygonEditor; ðaka L.Editable.PolygonEditor
	    // ðinherits PathEditor
	    L$$1.Editable.PolygonEditor = L$$1.Editable.PathEditor.extend({
	        ...
	        // ðmethod newHole(latlng?: L.LatLng, index: int)
	    ...
	    // ðnamespace Editable; ðclass RectangleEditor; ðaka L.Editable.RectangleEditor
	    // ðinherits PathEditor
	    ...
	    // ðnamespace Editable; ðclass CircleEditor; ðaka L.Editable.CircleEditor
	    // ðinherits PathEditor
	    ...
	    // ðnamespace Editable; ðclass EditableMixin
	    ...
	    var EditableMixin = {
	        ...
	        // ðmethod enableEdit(map?: L.Map): this.editor
	        ...
	        // ðmethod editEnabled(): boolean
	        // Return true if current instance has an editor attached, and this editor is enabled.
	        editEnabled: function () {
	            return this.editor && this.editor.enabled();
	        },

	        // ðmethod disableEdit()
